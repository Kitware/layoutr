  ...
  <v-app>
    <v-navigation-drawer fixed app class="pa-4">
      ...
      <v-slider
        ...
        hide-details
      ></v-slider>
      <v-combobox v-model="sizeField" :items="['None', ...fields]" label="Size field" hide-details></v-combobox>
      <v-btn
        block
        :disabled="!layoutLoaded"
        @click="toggleLayout"
      >{{ layoutRunning ? 'Stop' : 'Start' }} layout</v-btn>
      <v-slider
        v-model="alpha"
        :min="0.00"
        :max="1.00"
      ...
      <v-slider
        ...
        hide-details
      ></v-slider>
      <v-checkbox v-model="center" label="Center force" hide-details></v-checkbox>
      <v-slider
        v-model="xStrength"
        :min="0.00"
        :max="1.00"
        ...
        hide-details
      ></v-slider>
      <v-combobox v-model="xField" :items="fields" label="X field" hide-details></v-combobox>
      <v-slider
        v-model="yStrength"
        :min="0.00"
        :max="1.00"
        ...
        hide-details
      ></v-slider>
      <v-combobox v-model="yField" :items="fields" label="Y field" hide-details></v-combobox>
      <v-slider
        ...
        hide-details
      ></v-slider>
      <v-combobox v-model="radialField" :items="fields" label="Radial field" hide-details></v-combobox>
